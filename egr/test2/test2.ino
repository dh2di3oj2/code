...
const int skipPin = X;  // the number of the pushbutton pin
...
const int buttonPin = X;  // the number of the pushbutton pin
...
// print out some info. about the wave file
  ...
  long channels = waveFile2.channels();
  Serial.print("Channels = ");
  Serial.println(channels);

  long sampleRate = waveFile2.sampleRate();
  Serial.print("Sample rate = ");
  Serial.print(sampleRate);
  Serial.println(" Hz");

  long duration = waveFile2.duration();
  Serial.print("Duration = ");
  Serial.print(duration);
  Serial.println(" seconds");
